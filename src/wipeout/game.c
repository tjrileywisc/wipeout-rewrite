...
const game_def_t def = {
	...
	.ai_settings = {
		[RACE_CLASS_VENOM] = {
			...
			// TODO: ai_settings for additional courses
		},
		[RACE_CLASS_RAPIER] = {
	...
	.circuts = {
		...
		// Autogenerated settings for Wipeout 2097 and Wipeout 64 tracks
		[CIRCUT_TALONS_REACH] = {
			// Any punctuation stripped (not in font)
			.name = "TALONS REACH",
			// Dummy settings. These need to be extracted properly.
			.is_bonus_circut = false,
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track01/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track01/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_SAGARMATHA] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track08/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track08/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_VALPARAISO] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track13/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track13/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_PHENITIA_PARK] = {
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track20/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track20/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_GARE_DEUROPA] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track02/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track02/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_ODESSA_KEYS] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track17/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track17/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_VOSTOK_ISLAND] = {
			...
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track06/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track06/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_SPILSKINANKE] = {
			// Any punctuation stripped (not in font)
			...
			.is_bonus_circut = false,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track07/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track07/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_UNFINISHED_TRACK] = {
			...
			// According to leftover build system artifacts, this was intended
			// to be a bonus circut. Additionally, at the time of writing it
			// will crash the game on load, and this exempts it from being
			// automatically picked for the attract mode.
			.is_bonus_circut = true,
			.release = GAME_WIPEOUT_2097,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout2/track04/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout2/track04/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_KLIES_BRIDGE] = {
			// Any punctuation stripped (not in font)
			...
			// Dummy settings. These need to be extracted properly.
			.is_bonus_circut = false,
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track01/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track01/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_QORON_IV] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track02/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track02/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_SOKANA] = {
			// Any punctuation stripped (not in font)
			...
			.is_bonus_circut = false,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track03/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track03/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_DYRONESS] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track04/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track04/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_MACHAON_II] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track05/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track05/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_TERAFUMOS] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track06/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track06/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
		[CIRCUT_VELOCITAR] = {
			// Any punctuation stripped (not in font)
			...
			.release = GAME_WIPEOUT_64,
			.settings = {
				[RACE_CLASS_VENOM]  = {.path = "wipeout64/track07/", .start_line_pos = 27, .behind_speed = 300, .spread_base = 80, .spread_factor = 20, .sky_y_offset = 0},
				[RACE_CLASS_RAPIER] = {.path = "wipeout64/track07/", .start_line_pos = 27, .behind_speed = 500, .spread_base = 80, .spread_factor = 11, .sky_y_offset = 0},
			}
		},
	},
	.music = {
...
save_t save = {
	...
	.highscores = {
		[RACE_CLASS_VENOM] = {
			...
			// Stub highscores for additional tracks. Left uninitialized
			// these are all zero, an unbeatable time. 3599.99 = 59:99.9
			{
				[HIGHSCORE_TAB_RACE]       = {.lap_record = 3599.99, .entries = {{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99}}},
				[HIGHSCORE_TAB_TIME_TRIAL] = {.lap_record = 3599.99, .entries = {{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99}}},
			},
			{
				[HIGHSCORE_TAB_RACE]       = {.lap_record = 3599.99, .entries = {{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99}}},
				[HIGHSCORE_TAB_TIME_TRIAL] = {.lap_record = 3599.99, .entries = {{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99},{"NUL", 3599.99}}},
